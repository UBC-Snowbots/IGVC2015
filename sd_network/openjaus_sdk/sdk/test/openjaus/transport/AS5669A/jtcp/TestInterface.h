...
#include "openjaus/transport/AS5669A/jtcp/Interface.h"
...
public:
	...
	openjaus::transport::AS5669A::jtcp::Interface *interface;
	// End of user code
	
	void setUp()
	{
		// Start of user code test setup:
		interface = new openjaus::transport::AS5669A::jtcp::Interface();	
