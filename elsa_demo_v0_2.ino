    ...
    while(hal.console->available() >=7)
    {
      ...
      if(Byte[0]=='B')// make sure all data begains with a zero
      {
        ...
        /*char outbytes[10];
         ...
         outbytes[8]=Lspeed>>8;
         outbytes[9]=Lspeed;
         hal.console->printf("%c%c%c%c%c%c%c%c%c%c", outbytes[0], outbytes[1], outbytes[2], outbytes[3], outbytes[4], outbytes[5], outbytes[6], outbytes[7], outbytes[8], outbytes[9]);
         */
      }
    }
  }
