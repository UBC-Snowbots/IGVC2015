...
///
///   Not thread safe, must be updated by main GUI
///
...
public:
    ...
    ~wxImagePanel() {}
    bool SetBitmap(const wxBitmap& img) { return SetImage(img.ConvertToImage()); }
...
protected:
    ...
    wxMutex mThreadProtection;
    volatile bool mResizeFlag;
    DECLARE_EVENT_TABLE()
};
