...
ifeq ($(config),debug)
  OBJDIR     = Debug/Managed
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/Managed
  DEFINES   += -DDEBUG
  INCLUDES  += -I../include
...
$(OBJDIR)/Managed.o: ../test/openjaus/core/Managed.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
