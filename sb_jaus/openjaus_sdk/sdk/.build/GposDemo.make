...
ifeq ($(config),debug)
  OBJDIR     = Debug/GposDemo
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/GposDemo
  DEFINES   += -DDEBUG
  INCLUDES  += -I../include
...
$(OBJDIR)/GposDemo.o: ../test/openjaus/mobility/GposDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
