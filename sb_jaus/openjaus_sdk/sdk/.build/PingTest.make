...
ifeq ($(config),debug)
  OBJDIR     = Debug/PingTest
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/PingTest
  DEFINES   += -DDEBUG
  INCLUDES  += -I../include
...
$(OBJDIR)/PingTest.o: ../test/openjaus/core/PingTest.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
