...
//Heading: 111.20 (-112,-289,-417) i2c error: 0 offsets(97.39, 178.85, 217.25) t=246

    compass.set_offsets(97.39, 178.85, 217.25); // set offsets to account for surrounding interference
    compass.set_declination(ToRad(-86)); // set local difference between magnetic north and true north
