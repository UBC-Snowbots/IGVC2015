...
#include "AP_BatteryMon.h"

extern const AP_HAL::HAL& hal;

const AP_Param::GroupInfo AP_BatteryMon::var_info[] PROGMEM = {
    // @Param: MONITOR
    // @DisplayName: Battery monitoring
    // @Description: Controls enabling monitoring of the battery's voltage and current
    // @Values: 0:Disabled,3:Voltage Only,4:Voltage and Current
    // @User: Standard
    AP_GROUPINFO("MONITOR", 0, AP_BatteryMon, _monitoring, AP_BATT_MONITOR_DISABLED),
    ...
    // @User: Standard
    AP_GROUPINFO("VOLT_PIN", 1, AP_BatteryMon, _volt_pin, AP_BATT_VOLT_PIN),
    ...
    // @User: Standard
    AP_GROUPINFO("CURR_PIN", 2, AP_BatteryMon, _curr_pin, AP_BATT_CURR_PIN),
    ...
    // @User: Advanced
    AP_GROUPINFO("VOLT_MULT", 3, AP_BatteryMon, _volt_multiplier, AP_BATT_VOLTDIVIDER_DEFAULT),
    ...
    // @Units: A/V
    // @User: Standard
    AP_GROUPINFO("AMP_PERVOLT", 4, AP_BatteryMon, _curr_amp_per_volt, AP_BATT_CURR_AMP_PERVOLT_DEFAULT),
    ...
    // @Units: Volts
    // @User: Standard
    AP_GROUPINFO("AMP_OFFSET", 5, AP_BatteryMon, _curr_amp_offset, 0),
    ...
    // @Increment: 50
    // @User: Standard
    AP_GROUPINFO("CAPACITY", 6, AP_BatteryMon, _pack_capacity, AP_BATT_CAPACITY_DEFAULT),
...
// their values.
//
AP_BatteryMon::AP_BatteryMon(uint8_t volt=0, uint8_t curr=1) :
    _voltage(0),
    _current_amps(0),
...
uint8_t AP_BatteryMon::capacity_remaining_pct() const
{
...
bool AP_BatteryMon::exhausted(float low_voltage, float min_capacity_mah)
{
