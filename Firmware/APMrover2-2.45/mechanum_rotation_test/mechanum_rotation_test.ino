...
void move_pwm()
{
  ...
  else if(rc[3].control_in < 650)
  {
    ...
    if(rc[0].control_in>52)
    {
      wheels[0]=1600+rc[2].control_in-rc[1].control_in;//+z*(a+b)
      wheels[1]=1600+rc[2].control_in+rc[1].control_in;
      wheels[2]=1600-rc[2].control_in+rc[1].control_in;
      wheels[3]=1600-rc[2].control_in-rc[1].control_in;
    }
    else
    {
