...
void setup()
{
  ...
  hal.gpio->pinMode(51, GPIO_OUTPUT);//red
  hal.gpio->write(51, HIGH);
  hal.gpio->pinMode(52, GPIO_OUTPUT);//green
  hal.gpio->write(52, LOW);
  hal.gpio->pinMode(53, GPIO_INPUT);//toogle
  ToggleOn=hal.gpio->read(53);
...
void move_pwm()
{
  ...
  if(hal.gpio->read(53)==LOW)
  {
    ...
    {
      hal.gpio->write(52, HIGH);
    hal.gpio->write(51, LOW);
      a_led->write(0);
      if(LEDcount>40)
      {
        LEDcount=0;
