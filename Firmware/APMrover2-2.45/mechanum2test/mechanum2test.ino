...
AP_BattMonitor battery_mon(1,0);
...
void move_pwm()
{
  ...
  else if(rc[2].control_in < 650)
  {
    ...
    wheels[2]=1500-rc[3].control_in+rc[1].control_in-rc[0].control_in-10;
...
{	
  rc_1.radio_min = 1050;//1048,1463,1879
  rc_2.radio_min = 1076;//1054,1483,1879
  rc_3.radio_min = 1051;//1050,1466,1875
  rc_4.radio_min = 1055;
  rc_5.radio_min = 1085;
  rc_6.radio_min = 1085;
  rc_7.radio_min = 1085;
...
*/
  ...
  // 3 is not trimed
  rc_1.radio_trim = 1472;//-28
  rc_2.radio_trim = 1496;//-1
  rc_3.radio_trim = 1500;//-22
